   ...
   <div class="modal fade" id="myModaladdcategory" role="dialog">
    ...
    <form action="addCategory" method="post">
      <div class="modal-content" style="background-color:#15477B;color:white">
    	...
    	<table style="color:white;">
                      <tr>
        <td><b><label >Category Name:</label></b></td>
    	<td><input type="text" name="cname" style="color:black;" value="N/A"></td>
    	</tr>
    	</table>
        </div>
        <div class="modal-footer">
...
<h1 style="font-size:40px;text-align:center;font-weight:bold">CATEGORY LIST</h1>
<a href="#" data-toggle="modal" data-target="#myModaladdcategory" class="btn btn-danger" style="background-attachment:fixed;position:absolute;right:150px;top:70px">Add new category</a><br>
<table class="table" style="color:white">
	<tr>
		<th style="border: 1px solid white;text-align:center">Category ID</th>
		<th style="border: 1px solid white;text-align:center">Category Name</th>
	</tr>
	<c:forEach items="${clist}" var="c">
	<form action="editCategory?cid=${c.categoryID}" method="post">
	<tr>
		<td style="border: 1px solid white">${c.categoryID}</td>
		<td style="border: 1px solid white">${c.categoryName}</td>
		<td style="text-align:center;"><input type="text" name="cname" style="color:black;" value="${gdtbean.directx}"><br></td>
		<td style="text-align:center;"><button name="butsua" type="submit" style="background-color:red"><i class='fas fa-edit'></i></button></td>
		<td style="text-align:center;"><button name="butxoa" type="submit" style="background-color:red"><i class='fas fa-eraser'></i></button></td>
	</tr>
	</form>	
	</c:forEach>
</table>
